...
#
#     # Generate arguments for functions
#     snapshot_arguments = [[file_name, constellation_name, total_sat, orbital_period, max_communication_dist,
#                            satellite_degree_constraints, t, params,
#                            "./" + constellation_name + "_isls_" + str(t) + ".txt"] for t in snapshot_ids]
#
#     # Run topology generation algorithm for each specified snapshot
#     start = time.time()
#
