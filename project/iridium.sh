...
echo -n "Visualising..."
python analysis/visualisation.py --tles iridium-constellation_tles.txt.tmp --location ./plus_grid/iridium-780 --constellation_name Iridium-780 --snapshot_interval 60 --method plus_grid --topology-type static --num_snapshots 97
...
echo -n "Visualising..."
python analysis/visualisation.py --tles iridium-constellation_tles.txt.tmp --location ./Results/mdtd/iridium-780 --constellation_name Iridium-780 --snapshot_interval 60 --method mdtd --topology-type dynamic --num_snapshots 97
...
echo -n "Visualising..."
python analysis/visualisation.py --tles iridium-constellation_tles.txt.tmp --location ./novel/primal/iridium-780 --constellation_name Iridium-780 --snapshot_interval 60 --method novel --topology-type dynamic --num_snapshots 97
